      ...
      <DialogContent className="copy-trading-theme glass-strong max-h-[92vh] max-w-xl overflow-y-auto border-primary/20 p-0">
        ...
        <div className="space-y-5 p-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div><div className="mb-2 flex items-center justify-between"><label htmlFor="max-per-trade" className="text-sm font-medium">Max per trade</label><span className="text-xs text-muted-foreground">BI2XUSD</span></div><Input id="max-per-trade" type="number" min="1" value={maxPerTrade} onChange={(event) => setMaxPerTrade(event.target.value)} className="h-11 border-white/10 bg-white/[0.035] font-mono" /></div>
          </div>
      ...
      <DialogContent className="copy-trading-theme glass-strong max-h-[92vh] max-w-2xl overflow-y-auto border-primary/20 p-0">
        ...
        <div className="space-y-5 p-6">
          ...
          <section className="space-y-4 rounded-xl border border-primary/20 bg-primary/[0.055] p-4">
            ...
            <p className="text-[10px] text-muted-foreground">Example: at {form.commissionPercent}% commission, a Copier with 100 BI2XUSD realized profit pays {form.commissionPercent} BI2XUSD to the Lead Trader.</p>
          </section>
